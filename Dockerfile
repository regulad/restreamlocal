...
LABEL name="restreamlocal"
LABEL version="0.1.0"
LABEL vendor="Parker Wahle"
LABEL org.opencontainers.image.title="restreamlocal"
LABEL org.opencontainers.image.version="0.1.0"
LABEL org.opencontainers.image.url="https://github.com/regulad/restreamlocal"
LABEL org.opencontainers.image.documentation="https://restreamlocal.readthedocs.io"
...
COPY --from=builder /code/dist/restreamlocal-*.whl /tmp/
RUN pip install --user /tmp/restreamlocal-*.whl

# Now do something!
CMD ["/home/restreamlocal/.local/bin/restreamlocal"]
